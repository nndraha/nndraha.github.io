...
def process_and_classify(text, raw_title):
    ...
    try:
        ...
        prompt = (
            ...
            "3. Summarize: Write a 5-7 sentences summary of the abstract at a 5th-grade reading level.\n"
            "4. Implication: State the practical implication of this study for food science in 4-7 sentences.\n"
